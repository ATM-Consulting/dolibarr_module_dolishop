 ...
 */
class dolishopbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "dolishop@dolishop";
    public $boxlabel;
    public $depends = array("dolishop");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/dolishop/class/dolishop.class.php";
